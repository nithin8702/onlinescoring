/* login.js tabsize=4
 *
 * Displays the Login window and performs login requests.
 * By default, the login domain is '@neuroinfo.org'.
 * Change 'DEFAULT_DOMAIN' to specify a different default domain.
 *
